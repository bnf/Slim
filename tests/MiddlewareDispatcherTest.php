...
class MiddlewareDispatcherTest extends TestCase
{
    ...
    public function testNamedFunctionIsResolved()
    {
        ...
        $middlewareDispatcher->addLazy(__NAMESPACE__ . '\testProcessRequest');
    ...
    public function testDeferredResolvedCallable()
    {
        ...
        $middlewareDispatcher->addLazy('callable');
    ...
    public function testResolvableReturnsInstantiatedObject()
    {
        ...
        $handler = new MockRequestHandler();
        $middlewareDispatcher = new MiddlewareDispatcher($handler);
        $middlewareDispatcher->addLazy(MockMiddlewareWithoutConstructor::class);
    ...
    public function testResolveThrowsExceptionWhenResolvableDoesNotImplementMiddlewareInterface()
    {
        ...
        $handler = new MockRequestHandler();
        $middlewareDispatcher = new MiddlewareDispatcher($handler, $container);
        $middlewareDispatcher->addLazy('MiddlewareInterfaceNotImplemented');
    ...
    public function testResolveThrowsExceptionWithoutContainerAndUnresolvableClass()
    {
        $handler = new MockRequestHandler();
        $middlewareDispatcher = new MiddlewareDispatcher($handler);
        $middlewareDispatcher->addLazy('Unresolvable::class');
    ...
    public function testExecutesMiddlewaresLastInFirstOut()
    {
        ...
        $dispatcher->addLazy(MockSequenceMiddleware::class);
    ...
    public function testThrowsExceptionForLazyNonMiddlewareInterfaceClasses()
    {
        ...
        $dispatcher = new MiddlewareDispatcher($kernelProphecy->reveal());
        $dispatcher->addLazy(\stdClass::class);
    ...
    public function testFetchesMiddlewareFromContainer()
    {
        ...
        $dispatcher->addLazy('somemiddlewarename');
        $response = $dispatcher->handle($requestProphecy->reveal());
